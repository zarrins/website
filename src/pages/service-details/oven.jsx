...
const index = () => {
  return (
    <WrapperFour>
      <SEO pageTitle={"تعمیرات ماکروفر"} />
      <Breadcrumb title="تعمیرات ماکروفر" subtitle="تعمیرات ماکروفر" isDbbl="خدمات" />
                  ...
                  <div className="c-details-wrapper mr-25">
                     ...
                     <div className="service-details-content mt-40 mb-45">
                        ...
                        <div className="tpservice__ava-title mb-25">
                           <h4 className="c-details-title"><a href="#">تعمیرات مایکروفر</a></h4>
                        </div>
                     </div>
