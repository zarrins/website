...
const index = () => {
  return (
    <WrapperFour>
      <SEO pageTitle={"تعمیرات ماشین ظرفشویی"} />
      <Breadcrumb title="تعمیرات ماشین ظرفشویی" subtitle="تعمیرات ماشین ظرفشویی" isDbbl="خدمات" />
                  ...
                  <div className="c-details-wrapper mr-25">
                     <div className="service-details-content mt-40 mb-45">
                        <div className="tpservice__ava-title mb-25">
                           <h4 className="c-details-title"><a href="#">تعمیرات ماشین ظرفشویی</a></h4>
                        </div>
                     </div>
               ...
               <div className="col-lg-6 col-md-12">
                  <div className="c-details-sidebar">
                     <div className="c-details-thumb p-relative">
                        <img src="/assets/img/service/c-details-bg-02.jpg" alt="details-bg" />
                     </div>
                  </div>
               </div>
            </div>
