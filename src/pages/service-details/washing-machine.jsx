...
const index = () => {
  return (
    <WrapperFour>
      <SEO pageTitle={"تعمیرات ماشین لباسشویی"} />
      <Breadcrumb title="تعمیرات ماشین لباسشویی" subtitle="تعمیرات ماشین لباسشویی" isDbbl="خدمات" />
            ...
            <div className="row c-details-sidebar" style={{paddingBottom: "50px"}}>
                  ...
                  <div className="c-details-wrapper mr-25">
                     ...
                     <div className="service-details-content mt-40 mb-45">
                        ...
                        <div className="tpservice__ava-title mb-25">
                           <h4 className="c-details-title"><a href="#">تعمیرات ماشین لباسشویی</a></h4>
                        </div>
               ...
               <div className="col-lg-6 col-md-12">
                  ...
                  <div className="c-details-thumb p-relative">
                        <img src="/assets/img/service/c-details-bg-05.jpg" alt="details-bg" />
