            ...
            <div className="row">
               <div className="col-lg-6 col-md-12">
                  <div className="c-details-wrapper mr-25">
                     ...
                     <div className="service-details-content mb-45">
                        <div className="tpservice__category mb-15">
               ...
               <div className="col-lg-6 col-md-12">
                  ...
                  <div className="c-details-thumb p-relative mb-40">
                        <img src="/assets/img/service/c-details-bg-01.jpg" alt="details-bg" />
                     ...
                     {/* <div className="service-details-widget">
                        <div className="cd-video-price">
                           ...
                           <div className="cd-pricing-btn text-center mb-30">
                              <Link className="tp-vp-btn" href="/service-details">Add To Cart</Link>
                              <Link className="tp-vp-btn-green" href="/service-details">Enroll Now</Link>
                           </div>
                        </div>
